...
class GovForgotPass extends StatelessWidget {
  const GovForgotPass({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    child: AppBar(
        ...
        body: const GovForgotPassWidget(),
      ),
    );
  }
}
...
class GovForgotPassWidget extends StatefulWidget {
  ...
  @override
  State<GovForgotPassWidget> createState() => _GovForgotPassWidgetState();
}

class _GovForgotPassWidgetState extends State<GovForgotPassWidget> {
