...
//   // }
//
//   Future<bool?> doesUserExist(username, email) async {
//     try {
...
//                 child: Expanded(
//                     child: StreamBuilder(
//                         stream: data.where('uid', isEqualTo: cUser.currentUser!.uid)
//                             .snapshots(),
//                         builder: (context,
...
//                 return 'This Field is Required';
//               }
//               else if(value != null && doesUserExist(value, emailController.text) == true){
